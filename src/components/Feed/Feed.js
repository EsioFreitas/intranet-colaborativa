...
class feed extends Component {
    ...
    return (
      <div className="feed">
        ...
        <section className="feed__container">
          {Object.keys(this.state.statePosts)
            .map((post, idx) => {
                ...
                <article key={post} className="feed__article">
                    ...
                    <ul className="feed__comentarios">
                      {Object.keys(postMap.comentarios).map(comentario => (
                        <li key={comentario} className="feed__comentario">
                          <img
                            src={
                              postMap.comentarios[comentario].photoComentario
                            }
                          />
                          <div>
                  ...
                  <div className="feed__perfil-comentario">
                    ...
                    <Input
                      ...
                      change={event =>
                        this.setState({ comentText: event.target.value })
                      }
                    />
                  </div>
                </article>
  ...
  newpost = () => {
    ...
    let tmp = [...this.state.statePosts, newPost];
