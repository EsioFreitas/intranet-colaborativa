        ...
        <div className='aniversariantes__carousel'>
            {
                Object.keys(aniverHelper).map(pessoa => (
                    <div key={pessoa} className='aniversariantes__pessoa'>
                        ...
                        <img src={aniverHelper[pessoa].photo} alt={aniverHelper[pessoa].name} />
                        <div>
            ...
            <div className='aniversariantes__carousel__controuls-btn aniversariantes__carousel__controuls-btn--prev'>&#10094;</div>
            <div className='aniversariantes__carousel__controuls-btn aniversariantes__carousel__controuls-btn--next'>&#10095;</div>
        </div>
    </div>
);
